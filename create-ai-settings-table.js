...
async function createAISettingsTable() {
    console.log('🔧 Creating AI Settings Table');
    console.log('=============================');
    ...
    try {
        ...
        await client.query(`
            INSERT INTO ai_settings (id, enabled, provider, model, max_tokens, temperature, system_prompt, rate_limit_per_user, rate_limit_window, welcome_message)
            VALUES (1, true, 'gemini', 'gemini-pro', 1000, 0.7, 
        ...
        // Create ai_analytics table if not exists
        await client.query(`
        ...
        `);
        console.log('✅ ai_analytics table created/verified');
        ...
        console.log('\n🎉 AI Settings Database Setup Complete!');
        console.log('=====================================');
        ...
        console.log('\n🎯 Next Steps:');
        console.log('1. AI Assistant is now enabled by default');
        console.log('2. Go to Admin Panel → AI Assistant to configure');
        console.log('3. Test the AI Assistant in the frontend');

    } catch (error) {
        console.error('❌ Error creating AI settings table:', error);
        process.exit(1);
    }
}

createAISettingsTable().catch(console.error);