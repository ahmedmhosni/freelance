...
const seedDatabase = async () => {
  try {
    ...
    projectRequest.input('budget', sql.Decimal(10, 2), 15000.0);
    ...
    task1Request.input(
      'description',
      sql.NVarChar,
      'Create initial design mockups for homepage and key pages'
    );
    ...
    invoiceRequest.input('amount', sql.Decimal(10, 2), 5000.0);
    invoiceRequest.input('tax', sql.Decimal(10, 2), 500.0);
    invoiceRequest.input('total', sql.Decimal(10, 2), 5500.0);
    ...
    invoiceRequest.input(
      'notes',
      sql.NVarChar,
      'First milestone payment - 30% deposit'
    );
