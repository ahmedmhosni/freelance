...
class EmailService {
  ...
  async sendPasswordResetEmail(user, token, code) {
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>Hi ${user.name},</p>
            <p>We received a request to reset your password. Choose one of the options below:</p>
            ...
            <div class="code-box">
              ...
              <div class="code">${code}</div>
              <p style="margin: 10px 0 0 0; font-size: 12px; color: #999;">Enter this code on the reset page</p>
            </div>
    ...
    const text = `
      ...
      We received a request to reset your password. Choose one of these methods:
