...
import { useTheme, api, LogoLoader, SEO } from '../../../shared';
import { 
...
const PublicProfile = () => {
  ...
  const socialLinks = [
    { name: 'LinkedIn', icon: FaLinkedin, url: profile?.linkedin, color: '#0077b5' },
    { name: 'Behance', icon: FaBehance, url: profile?.behance, color: '#1769ff' },
    { name: 'Instagram', icon: FaInstagram, url: profile?.instagram, color: '#E4405F' },
    { name: 'Facebook', icon: FaFacebook, url: profile?.facebook, color: '#1877f2' },
    { name: 'Twitter', icon: FaTwitter, url: profile?.twitter, color: '#1DA1F2' },
    { name: 'GitHub', icon: FaGithub, url: profile?.github, color: isDark ? '#fff' : '#333' },
    { name: 'Dribbble', icon: FaDribbble, url: profile?.dribbble, color: '#ea4c89' }
    ...
    <>
      ...
      <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {profile.website && (
                <a
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.backgroundColor = isDark ? '#252540' : '#f0f0f0';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.backgroundColor = isDark ? '#1a1a2e' : '#f8f9fa';
                  }}
                >
                  <MdLanguage />
                  Website
        ...
        <div style={{
          ...
          <p>
            Powered by <a href="/" style={{ color: '#8b5cf6', textDecoration: 'none' }}>Roastify</a>
          </p>
        </div>
      </div>
      </div>
