  ...
  const features = [
    {
      ...
      description:
        'Stop juggling spreadsheets. Keep all your client info in one place.',
      benefits: [
    ...
    },
    {
      title: 'Time Tracking',
      description:
        'Click start, do your work, click stop. No complicated setup.',
      benefits: [
    ...
    },
    {
      ...
      description:
        'Kanban boards, lists, calendars—view your work however makes sense.',
      benefits: [
    ...
    },
    {
      ...
      description:
        'See where your time and money are going. Export what you need.',
      benefits: [
