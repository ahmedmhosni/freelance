import { MdPeople, MdAccessTime, MdFolder, MdBarChart, MdViewKanban } from 'react-icons/md';

// Real Client Management Table (from Clients.jsx)
export const ClientManagementDemo = ({ isDark }) => {
  const sampleClients = [
    { id: 1, name: 'Sarah Johnson', email: 'sarah@designstudio.com', company: 'Design Studio Co', phone: '+1 (555) 123-4567' },
    { id: 2, name: 'Michael Chen', email: 'michael@techcorp.com', company: 'Tech Corp', phone: '+1 (555) 234-5678' },
    { id: 3, name: 'Emma Williams', email: 'emma@creative.io', company: 'Creative Agency', phone: '+1 (555) 345-6789' }
  ];
    ...
    <div className="card" style={{ 
      ...
      <div className="table-container" style={{ overflowX: 'auto' }}>
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ 
              borderBottom: isDark ? '2px solid rgba(255, 255, 255, 0.1)' : '2px solid rgba(55, 53, 47, 0.1)'
            }}>
              <th style={{ 
                textAlign: 'left', 
                padding: '12px',
          ...
          <tbody>
            {sampleClients.map(client => (
              <tr 
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = isDark ? 'rgba(255, 255, 255, 0.03)' : 'rgba(55, 53, 47, 0.03)';
                }}
                onMouseLeave={(e) => {
    ...
    <div className="card" style={{ 
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'flex', gap: '8px' }}>
          ...
          onMouseLeave={(e) => {
            e.currentTarget.style.background = isDark ? 'rgba(255, 255, 255, 0.05)' : 'rgba(55, 53, 47, 0.05)';
            e.currentTarget.style.transform = 'translateY(0)';
          }}>
            <div style={{ fontSize: '20px', fontWeight: '600', color: isDark ? '#fff' : '#37352f' }}>
              8.5h
            </div>
...
export const ProjectManagementDemo = ({ isDark }) => {
  const sampleProjects = [
    { id: 1, name: 'Website Redesign', status: 'In Progress', progress: 65, color: '#3b82f6', client: 'Design Studio Co' },
    { id: 2, name: 'Mobile App', status: 'Planning', progress: 20, color: '#f59e0b', client: 'Tech Corp' },
    { id: 3, name: 'Brand Identity', status: 'Completed', progress: 100, color: '#10b981', client: 'Creative Agency' }
  ];
    ...
    <div className="card" style={{ 
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
          ...
          <div style={{ fontSize: '16px', fontWeight: '600', color: isDark ? '#fff' : '#37352f' }}>
            Revenue Overview
          </div>
        </div>
        <div style={{ display: 'flex', gap: '12px', marginBottom: '20px' }}>
          {[
            { label: 'This Month', value: '$12,450', color: '#10b981', trend: '+35%' },
            { label: 'Last Month', value: '$9,230', color: '#3b82f6', trend: '+12%' }
          ].map((stat, i) => (
            <div 
              key={i} 
              style={{
