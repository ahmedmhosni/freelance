              ...
              >
                ...
                <div
                  style={{
                    ...
                    gap: '6px',
                    marginBottom: '2px',
                    color: passwordReqs.hasUppercase
                      ? '#2eaadc'
                      : isDark
                        ? 'rgba(255, 255, 255, 0.5)'
                        : 'rgba(55, 53, 47, 0.5)',
                ...
                <div
                  style={{
                    ...
                    gap: '6px',
                    marginBottom: '2px',
                    color: passwordReqs.hasLowercase
                      ? '#2eaadc'
                      : isDark
                        ? 'rgba(255, 255, 255, 0.5)'
                        : 'rgba(55, 53, 47, 0.5)',
                ...
                <div
                  style={{
                    ...
                    alignItems: 'center',
                    gap: '6px',
                    color: passwordReqs.hasSpecialChar
                      ? '#2eaadc'
                      : isDark
                        ? 'rgba(255, 255, 255, 0.5)'
                        : 'rgba(55, 53, 47, 0.5)',
