                      ...
                      {[...Array(24)].map((_, index) => {
                        const hourData = serviceHistory.find((h) => {
                          const hourDiff = Math.floor(
                            (new Date() - new Date(h.hour)) / (1000 * 60 * 60)
                          );
                          return hourDiff === 23 - index;
                        });

                        const uptime = hourData
                          ? parseFloat(hourData.uptime)
                          : null;
                        ...
                        return (
                          <div
                            ...
                            title={
                              hasData
                                ? `${uptime}% uptime (${hourData.checks} checks)`
                                : 'No data'
                            }
                            style={{
                              flex: 1,
                            ...
                            onMouseLeave={(e) => {
                              e.currentTarget.style.opacity = hasData
                                ? '1'
                                : '0.3';
