  ...
  return (
    <div className="container">
      <div style={{ marginBottom: '24px' }}>
        ...
        <p className="page-subtitle">View insights and export data</p>
      </div>
        ...
        <div>
          ...
          <div className="card">
            ...
            >
              ...
              <button
                onClick={() =>
                  exportToCSV(financialReport.invoices, 'financial-report.csv')
                }
            ...
            >
              {Object.entries(financialReport.byStatus).map(
                ([status, count]) => (
                  <div
                    key={status}
                    style={{
        ...
        <div>
          ...
          >
            <div className="card" style={{ padding: '20px' }}>
              ...
              >
                {Object.entries(projectReport.byStatus).map(
                  ([status, count]) => (
                    <div
                      key={status}
                      style={{
            ...
            <div className="card" style={{ padding: '20px' }}>
              ...
              >
                {Object.entries(projectReport.tasksByStatus).map(
                  ([status, count]) => (
                    <div
                      key={status}
                      style={{
          ...
          <div className="card">
            <button
              onClick={() =>
                exportToCSV(projectReport.projects, 'projects-report.csv')
              }
              className="btn-primary"
        ...
        <div>
          ...
          <div className="card" style={{ marginBottom: '20px' }}>
            ...
            >
              ...
              <button
                onClick={() =>
                  exportToCSV(timeTrackingTasks, 'time-by-task.csv')
                }
                className="btn-primary"
              >
                Export CSV
          ...
          <div className="card" style={{ marginBottom: '20px' }}>
            ...
            >
              ...
              <button
                onClick={() =>
                  exportToCSV(timeTrackingProjects, 'time-by-project.csv')
                }
                className="btn-primary"
              >
                Export CSV
          ...
          <div className="card">
            ...
            >
              ...
              <button
                onClick={() =>
                  exportToCSV(timeTrackingClients, 'time-by-client.csv')
                }
                className="btn-primary"
              >
                Export CSV
