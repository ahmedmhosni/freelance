    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <path
              d="M12 2C9.5 2 7.5 3.5 7 5.5C6.5 7.5 7 9.5 8 11C9 12.5 10.5 13.5 12 14C13.5 13.5 15 12.5 16 11C17 9.5 17.5 7.5 17 5.5C16.5 3.5 14.5 2 12 2Z"
              fill={
                isDark ? 'rgba(168, 85, 247, 0.8)' : 'rgba(99, 102, 241, 0.8)'
              }
            />
            <path
              d="M12 14C10.5 14.5 9 15.5 8 17C7 18.5 6.5 20.5 7 22.5C7.5 24.5 9.5 26 12 26C14.5 26 16.5 24.5 17 22.5C17.5 20.5 17 18.5 16 17C15 15.5 13.5 14.5 12 14Z"
              fill={
                isDark ? 'rgba(99, 102, 241, 0.8)' : 'rgba(168, 85, 247, 0.8)'
              }
            />
            <ellipse
              cx="12"
