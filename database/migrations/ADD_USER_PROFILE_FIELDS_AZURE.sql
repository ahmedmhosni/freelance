-- ============================================
-- Add User Profile Fields Migration - AZURE
-- Run this in Azure Portal Query Editor
-- Database: roastifydbazure
-- ============================================

-- NOTE: Change database name if different
USE roastifydbazure;
GO

PRINT 'Adding user profile fields to Azure database...';
GO
...
PRINT '';
PRINT 'Next steps:';
PRINT '  1. Verify all fields were added (see results above)';
PRINT '  2. Test profile system in production';
PRINT '  3. Visit https://roastify.online/profile';
PRINT '';
GO
